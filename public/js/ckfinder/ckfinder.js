    ...
    return {
        basePath: basePath, connector: connector, _connectors: connectors, modal: function (e) {
            ...
            window.CKFinder = window.CKFinder || {}, window.CKFinder.connector = connector, window.CKFinder._connectors = connectors, window.CKFinder.basePath = function () {
                    ...
                    function newContext(l) {
                        ...
                        function a(e) {
                            ...
                            return o(t, h.onScriptLoad, S("\x1aws|z"), S("\x1fOOPFEA_T\\H^NOEOAWT")), o(t, h.onScriptError, S(":^NOQM")), {
                                node: t, id: t && t.getAttribute(S("0USGU\x18DRILSIYPQ[5-'"))
                            }
                        }
                ...
                var Gv, Fv = {
                    version: S("&\x16\x06\x19\x04\x18"), templateSettings: {
                        evaluate: /\{\{([\s\S]+?(\}?)+)\}\}/g,
                        interpolate: /\{\{=([\s\S]+?)\}\}/g,
                        encode: /\{\{!([\s\S]+?)\}\}/g,
                        use: /\{\{#([\s\S]+?)\}\}/g,
                ...
                var o = a.Events = {
                    on: function (e, t, n) {
                        return d(this, "on", e, [t, n]) && t && (this._events || (this._events = {}), (this._events[e] || (this._events[e] = [])).push({
                            callback: t, context: n, ctx: n || this
                        })), this
                    }, once: function (e, t, n) {
                ...
                n = f, i = (t = s).ChildViewContainer, t.ChildViewContainer = function (e, i) {
                    ...
                    storageType: d.CommandStorage, constructor: function (e) {
                ...
                return F.Error = F.extend.call(Error, {
                        ...
                        if (this._ensureElement()) {
                            ...
                            if (s && this.triggerMethod(S('?"$$,6 |4?(:\x0499'), this.currentView, this, t), this.currentView && i && delete this.currentView._parent, a ? this.empty() : s && l && this.currentView.off(S("\vhh}{b~k"), this.empty, this), l) {
                                ...
                                var u = F.isNodeAttached(this.el), c = [], d = f.extend({
                                    triggerBeforeAttach: this.triggerBeforeAttach, triggerAttach: this.triggerAttach
                                }, n);
                    ...
                    childViewEventPrefix: S("B ,,*#> /<"), sort: !0, constructor: function (e) {
                        ...
                        if (!t) throw new F.Error({
                            name: S("D\v)\x04  &/\x1a$+8\x15# <&"), message: S("6v\x18\x1bYSUQZi)$5ad(34<i(.l>>*384:11")
                        });
                        return t
                    ...
                    proto: {
                        getTemplate: function () {
                            ...
                            return t = i._getValue(t, this), n.extend(e, {
                                lang: this.finder.lang, config: this.finder.config
                            }, t)
                        }
                    }, util: {
                ...
                return e.extend({
                    ...
                    emptyView: i.extend({
                        name: S("=}P.5';0\b#)=\f';84"), template: S("'\x14MC]\fNBNCB\x0f\x11W^P\x1aU\\IH]Z[\x1d~}m'-3x")
                    }),
                ...
                "use strict";
                return e.extend({
                    name: S("A\x04,(!#5\x06('.\b$/#?6\x04:1\""), template: n, ui: {
                        error: S("(\x07OY^B\\\x02]TA@URS"), folderName: S('3][FBLbTZQX\x03\x1d.$5\x05+)"":\x07+&)o\x13')
                    }, events: {
                ...
                function e(e) {
                    ...
                    e.finder.request(S("\x0f|~swqg,\x7fq}\x7f")), e.data.response.error || (n.set(S("7PXIxTTR[2$,"), !0), e.finder.once(S("8ZUVQ\\P[z $7!7|\0-=\f$ )+=#"), function e(t) {
                        ...
                        name: S(".hUEt\\XQSEK"), folder: n, context: {parent: n}
                    }, null, null, 30))
                }
                ...
                return function (o) {
                    o.setHandler(S("\x10w}\x7fppd-{k\x7fzhx"), function (e) {
                        ...
                        if (n) o.request(S("<QQ^$$0y7-)0"), {text: o.lang.common.pleaseWait}), o.request(S("\nhc`cn~u(`q{r"), {
                            ...
                            var i = new s.Model({
                                dialogMessage: o.lang.folders.newNameLabel, folderName: e.newFolderName, error: !1
                        ...
                        if (!t.get(S("\x13qgdxj"))) {
                            ...
                            e.finder.request(S("<YW^,.%y  53:&3")), o.request(S("*MCAJJB\vQAQTBR"), {
                                parent: e.data.context.parent, newFolderName: n
                            })
                        }
                ...
                function t(e) {
                    ...
                    i[0].get(S("1T\\XQSE")).get(S("\flmc")).fileDelete ? (t = 1 < i.length ? n.lang.files.deleteConfirmation.replace(S("&\\KF_EXP"), i.length) : n.lang.files.fileDeleteConfirmation.replace(S(" ZLBI@["), function () {
                        ...
                        name: S(")nN@HZJvX^VwZXQQKW"), msg: t, context: {files: i}
                ...
                return function (r) {
                    r.on(S("9^R]QQXz\x05'/!1#\x01'%..>\x0e!!68 >n:="), function (e) {
                        ...
                        r.request(S("*GCLJJB\vA[[B"), {text: r.lang.common.pleaseWait}), r.request(S("C'*+*)'.q?( +"), {
                            name: S("\x1dZzLDVFbJJCM["), type: S("5FXKM"), folder: t, context: {folder: t}
                        }, r)
                        ...
                        t.on(S("9\\TPY[Mz*': *1)"), function (e) {
                            ...
                            e.data.shortcuts.add({
                                label: e.finder.lang.shortcuts.folders.delete, shortcuts: S(",VJJ\\L")
                            })
                        }, null, null, 30)
                    }(r)
                }
                    ...
                    name: S("=zV!--$\x06023''9"), childView: n, initialize: function (e) {
                        this.collection = function (e, n) {
                            ...
                            return r.forEach(e, function (e) {
                                ...
                                i.push(r.extend({
                                    icons: {}, label: t, name: t, event: t.toLocaleLowerCase()
                                }, r.isString(e) ? n[t] : e))
                            }), i
                        }(e.buttons, {
                            okClose: {
                                ...
                                label: this.finder.lang.common.cancel, icons: {primary: S(",XG\x02YR]]\x19VZXK\\")}
                ...
                function r(e) {
                    ...
                    var n = !!s.isUndefined(e.captureFormSubmit) || e.captureFormSubmit, i = function (e, t, n) {
                        ...
                        if (e.view) i = e.view; else {
                            ...
                            n && (r.triggers = {
                                "submit form": {
                                    event: S("B01'+.<s,$> "), preventDefault: !0, stopPropagation: !1
                                }
                ...
                "use strict";
                return e.extend({
                    name: S("\x13]xwp}Ih~jt{h"), template: t, ui: {canvas: S("4\x1bU\\^\x14_R\x11^_Q6 1")}
                })
                    ...
                    events: {
                        collapsiblecollapse: function () {
                            ...
                            this.$el.find(S("%\bRA\x04ID@AO_CXP_Q\x18UXVM_UH")).attr({
                                id: e + S("2\x1e@TTGYW_W"), role: S("(]KI\\L@J\\"), "aria-labelledby": e + S("6\x1aLXX")
                            })
                ...
                return e.Model.extend({
                    defaults: {
                        file: null, caman: null, imagePreview: "", fullImagePreview: "", actions: null
                    }, initialize: function () {
                ...
                "use strict";
                return e.extend({
                    name: S("/sC]Cb\\S@"), template: n, className: S("3W^P\x1a]P\x17XNRN\x12#.,76**4"), ui: {
                        keepAspectRatio: S("\x12zzeccCw{vy <|KGaQKUmBMYkX\\HM[bPFZ[\x17k"),
                        apply: S("2\x10W^P\x1a]P\x17XNRN\x12!12/=")
                    }, triggers: {"click @ui.apply": S("6VHIVB")}, events: {
                ...
                "use strict";
                return e.extend({
                    name: S("1qA[EtX@oS^K"), className: S('"@OC\vBA\x04IYC]\x03XBPB'), template: t, ui: {
                        ...
                        e.stopPropagation(), n(window).on(S(")\\FCX]J]^DV"), {
                            model: t.model, view: t, moveStart: {
                ...
                return e.extend({
                    defaults: {name: S("=}M/1"), viewClass: t, view: null, isVisible: !1}, initialize: function () {
                        ...
                        this.viewModel.set({
                            ...
                            finder: this.collection.finder, model: this.viewModel
                ...
                "use strict";
                return e.extend({
                    name: S("\x1bNrj~TDtJAR"), template: n, ui: {
                        clockwise: S("B`'. j- g9#9/;5|1?;6= 1*?"), antiClockwise: S(">\x1c#*$n!,k5'=+?)`/!$81?;6= 1*?")
                    }, events: {
                ...
                return e.extend({
                    defaults: function () {
                        var t = this.collection.finder.config, e = [{
                            ...
                            name: S("2[AP"), icon: S("7[R\\\x16TH["), config: {min: 0, max: 100, step: 1, init: 0}
                        }, {
                            name: S("(ZO[EL"), icon: S("\nhgk#|ua{r"), config: {min: 0, max: 100, step: 1, init: 0}
                        }, {
                            name: S("\x13st{zy"), icon: S("\x19ypz0y~MLC"), config: {min: 0, max: 10, step: .1, init: 1}
                        }, {
                            name: S("?..+0!"), icon: S("!AHB\bHHAZO"), config: {min: 0, max: 100, step: 1, init: 0}
                        }, {
                            name: S("\x0el|xb"), icon: S("7[R\\\x16_QWO"), config: {min: 0, max: 100, step: 1, init: 0}
                        }, {
                            name: S("C7-'58,$"),
                            icon: S("\x16ts\x7f7ht|loEO"),
                            config: {min: 0, max: 100, step: 1, init: 0}
                        }, {
                            name: S("'[]KHGoBZB"), icon: S("\x14v}q5{vnn"), config: {min: 0, max: 20, step: 1, init: 0}
                        ...
                        var r = new o.Model({
                            filters: this.get(S("/VX^GQGE")), activeFilters: n, tabindex: this.get(S("7LXXRRY[G"))
                        });
                        this.on(S("=]W!/%&~ \".<\0'*+(\n.$0"), function (e, t) {
                ...
                "use strict";
                return e.extend({
                    name: S(":kNXMZ42\x14*!2"), template: i, events: {
                        ...
                        i && this.finder.config.initConfigInfo.thumbs || (i = this.finder.request(S("\x17qt{|y'nmEWKFSpTK"), {
                            file: e, maxWidth: 240, maxHeight: 80, noCache: !0
                        }));
                ...
                "use strict";
                return e.extend({
                    name: S("3fPE^B\\lRYJ"), template: n, className: S("\rmdv<wz9gsdqc\x7f6\x7frpkRNNP"), ui: {
                    ...
                    }, triggers: {"click @ui.apply": S(",L^_\\H")}, events: {
                        ...
                        this.model.set({
                            displayWidth: e, displayHeight: t
                ...
                return t.extend({
                    defaults: {name: S("\nYi~guu"), viewClass: n, view: null}, initialize: function () {
                        ...
                        l < s || a < o ? (e = o < s ? l / s : a / o, t = parseInt(e * s, 10), n = parseInt(e * o, 10)) : (n = o, t = s), i.set({
                            realWidth: o, realHeight: s
                        }), r.get(S("\x0fqrfz{{e")).push({
                            tool: this.get(S("\x14{wz}")), data: {width: o, height: s}
                ...
                return e.Collection.extend({
                    initialize: function () {
                        ...
                        if (i && i.length) {
                            ...
                            this.add({
                                title: t.lang.editImage.adjust, icon: S("\x10ryu9tr}mjn"), tool: r, tabindex: n
                        ...
                        if (o && o.length) {
                            ...
                            this.add({
                                title: t.lang.editImage.presets, icon: S("&DCO\x07[^H]JDB"), tool: s, tabindex: n
                ...
                "use strict";
                return e.extend({
                    name: S(",}\\@WCW@Gc_RO"), template: t, className: S("\x16ts\x7f7knrymERQ"), modelEvents: {
                ...
                return n.extend({
                    ...
                    onRender: function () {
                        this.$el.trigger(S("$FTBI]O")), this.progress.show(new i({
                            finder: this.finder, model: this.model
                        }))
                    },
                ...
                "use strict";
                return e.extend({
                    name: S("$`BN\\`GJKHm@^W[AYq_VTV]"), template: t, className: S("\x10ryu9p\x7f:{kuk1~qqTSMOW"), ui: {
                ...
                function r(e, i) {
                    ...
                    r.once(S("#TDAB\x12ZBD[\x17kKYE{^URS"), function () {
                        s.preview.show(t), s.actions.show(a), s.$el.trigger(S("<^LZ!5'")), r.request(S("$QIHDKKY\x16_K\\UE"), {
                            name: S("5sSQMsV]Z["), context: {tools: o}
                        });
                        var e = y(t._uiBindings.canvas, n.get(S("5_ZY^_kNXHV%6")), function () {
                            r.request(S("%JHIMOY\x16EGKU")), a.focusFirst(), n.set({
                                renderWidth: t.ui.canvas.width(), renderHeight: t.ui.canvas.height()
                            })
                        });
                        n.set(S("B %(')"), e)
                    });
                    var n = new h({
                        file: i, imagePreview: r.request(S(")CFMJK\x15@CWE]PAbJU"), {
                            file: i, maxWidth: .8 * window.innerWidth, maxHeight: .8 * window.innerHeight, noCache: !0
                        }), fullImagePreview: r.request(S("*BALIJ\nA@VB\\S@mKV"), {
                            file: i, maxWidth: 1e6, maxHeight: 1e6, noCache: !0
                        })
                    });
                    o.setImageData(n);
                    ...
                    l.on(S("\x14trs"), function () {
                        ...
                        name: S('A\v.%"#\x0e&/%'), folder: i.get(S("@'-/  4")), params: {fileName: i.get(S("\fcobu"))}
                    }).done(function (e) {
                    ...
                    a.set({value: w, message: s.lang.editImage.transformationAction}), o.doSave(e).then(function (e) {
                        ...
                        s.once(S("\x1c~qrM@LG\x1eD@SM[\x10xM[Kf]PUV"), function (e) {
                            e.data.response.error || (a.set({
                                state: S("\x1csqmM@N"), value: F, message: ""
                            }), t.set({
                                date: e.data.response.date, size: e.data.response.size
                        ...
                        e.data.toolbar.push({
                            ...
                            action: function () {
                                e.data.tools.hasDataToSave() ? i.request(S("%BNIEEL\x16NAAVX@^"), {
                                    name: S("\x17[vt}uosZDHVjIDABmQC_"), msg: i.lang.editImage.confirmExit
                ...
                function n(e) {
                    ...
                    a ? (o.allowClick = !0, o.linkAttributes = [{
                        name: S("4AWE_\\N"), value: S("=a], ,(")
                    }, {
                        name: S("4]DR^"), value: e.finder.request(S("$FIJEHDO\x16X\\C"), {
                ...
                return function (r) {
                    ...
                    r.setHandler(S("\x1c{wsE\x1bFLSKJHIM"), function (e) {
                        var t = e.file.get(S(")LD@IK]")), n = r.request(S("\x1e|OLOBJA\x1cRZE"), {
                            command: S("E\x02(?'&$-)\b&<4"), folder: t, params: {fileName: e.file.get(S("\x19tzqx"))}
                        }), i = s("#" + o);
                            ...
                            templateData: {
                                fileIcon: function () {
                                    ...
                                    return s.request(S(",KGCU\vUV@|UXV"), {
                                        size: t < e ? e : t, file: i.file, previewIcon: !0
                                    })
                                }, fileName: t
                    ...
                    o.setHandlers({
                        "image:previewUrl": function (e) {
                            ...
                            return t = e.file.get(S("(OEGHH\\")), n = {
                                ...
                                command: S("\x1eVM@EFtWCQAL]"), params: n, folder: t
                            })
                        ...
                        if (s.isExtensionOfImage(n) && (e.stop(), e.data.templateData.url = t, o.hasHandler(S("\x19sv}z{%PSGUM@QrZE")) && (e.data.templateData.url = o.request(S(",DCNWT\bCFP@^]NoIP"), {
                            ...
                            return h(S(".YYUW\\"), {
                                mp4: S("\x1bjtzzO\x0eOS\x10"), ogv: S("5@^\\\\U\x14SZY"), webm: S("\x10g{wqz9`}{w")
                            }, e)
                            ...
                            e.data.events = {
                                load: function (t) {
                                    t.currentTarget.alt && (i.get(S("?&..'!7")).getResourceType().get(S('D05"\x18;%35\x0e!"=0<7')) ? r(o.request(S("\x15p~t| |yiNmOY[vVI"), {
                                        file: i, cache: 86400, params: {d: i.get(S("\x14qwc}"))}
                ...
                "use strict";
                return n.extend({
                    name: S("#gJHSMQ^fIC["), template: "", tagName: S("\x0fv~`~"), events: {
                ...
                function h(e) {
                    ...
                    if (n.has(S("\x18pwz{xLzSHXF`DRF")) && n.get(S(")CFMJK}UB[IQqWCY")).has(S("?/3+$-+'+\x1b 0."))) i.resolve(n); else {
                        ...
                        y.isArray(t.config.resizeImages) && t.config.resizeImages.length && (o.sizes = t.config.resizeImages.join(",")), t.request(S("\x18zuvq|p{\x1aRGM@"), {
                            name: S("$bCSzLYBVHJf]PUVG"), folder: r, params: o, context: {dfd: i, file: n}
                        })
                    }
                    return i.promise()
                }
                ...
                function p(e) {
                    ...
                    return e.cache ? i.cache = e.cache : t.config.initConfigInfo.proxyCache && (i.cache = t.config.initConfigInfo.proxyCache), t.request(S("8ZUVQ\\P[z40/"), {
                        command: S("\x1bLoqgY"), params: i, folder: n.get(S("5PXT]_I"))
                    })
                }
                ...
                return function (i) {
                    this.finder = i, this.isEnabled = i.config.chooseFiles, i.config.ckeditor && (i.on(S("\x17~pv~o'}wONQF"), function (e) {
                        ...
                        "file:getUrl": {callback: v, context: this}, "file:getProxyUrl": {callback: p, context: this}
                        ...
                        return {
                            shouldFocusFirstChild: function () {
                                ...
                                if (this.collection.isLoading) {
                                    ...
                                    e = {
                                        title: this.finder.lang.common.pleaseWait + " " + n.title, text: n.text
                                    }, t = !0
                        ...
                        var n = {
                            ...
                            touchstart: function (t) {
                                ...
                                a(e.currentTarget).data(S("-MDV\x1c[]\x19AYB[Q")) ? e.preventDefault() : this.trigger(l(n) + S("-M@^EWK@XSYM"), {
                                    evt: e, model: n, el: document.getElementById(t)
                                })
                            }, click: function (e) {
                                var t = e.currentTarget.id, n = this.collection.get(t);
                ...
                return t.extend({
                    ...
                    initialize: function () {
                        this.model = new e.Model({
                            title: this.title, text: this.text, displayLoader: this.displayLoader
                        })
                    }
                })
                ...
                var u = {
                    ...
                    initialize: function (e) {
                        ...
                        if (e.displayConfig.set({
                            mode: S("B/-62"), thumbSizeString: null, currentThumbConfigSize: 0, thumbClassName: ""
                        }), e.mode === S("7LQOV^N")) {
                                ...
                                l.getOrCreate(S("\x1dxvLDQ\x19V@UNRL"), function () {
                                    t.$el.find(S('"OM')).not(S("Eh$#/g-%!+b92==")).addClass(S("\x18zq}1q\x7feY\fVKQHD")), t.$el.find(S("9VR\x12^UYm'+/!h/$''")).each(function () {
                                        r(this).find(S("\x15\x7fz\x7f")).attr(S("3GGU"), t.finder.request(S('@\'+/!\x7f!"<\0)$"'), {
                                            size: e, file: t.collection.get(this.id)
                                        }))
                                        ...
                                        thumbSize: e, thumbSizeString: i.thumb
                ...
                return i.extend(d, f), d.events = i.extend({
                    selectstart: function (e) {
                        ...
                        if (t === this.getOption(S(";XTMO, ;\0++ ./")).get(S("\x17kvho^d"))) {
                            ...
                            group: S("\x16qqu\x7fh"), name: S("\x1borlkbX"), value: t
                        })
                        ...
                        var t = this.collection.get(e.currentTarget.id);
                        this.trigger(S("\nhddbkfxwd.sy{||h!xoqo"), {
                            evt: e, model: t, el: r(e.target).find(S('8\x17YPZ\x10XV,$1n-+(":'))
                        })
                    }
                ...
                return e.extend(u, c), u.events = e.extend({
                    selectstart: function (e) {
                        ...
                        if (t === this.getOption(S("'L@Y[@LWl__TZS")).get(S("$VIU\\kS"))) {
                            ...
                            group: S("\x16qqu\x7fh"), name: S("\r}`bePj"), value: t
                        })
                    }, "dragstart .ckf-folder-item": function (e) {
                        e.preventDefault()
                    }, "dragend .ckf-folder-item": function (e) {
                        ...
                        this.trigger(S("+OEGCTG[VC\x0fPXT]_I\x06YLP0"), {
                            evt: e, model: t, el: i(e.target).find(S('Dk%,.d," (=b9?<6&'))
                        })
                    }
                                    ...
                                    var i = l(n), r = setTimeout(function () {
                                        ...
                                        var e = a.getOption(S("1VZGEZVAzUUZTY")).get(S("\n\x7fdxcmCxhvGad~v~")),
                                            t = s.request(S("2U]YS\r_\\NoTHS]"), {
                                                file: a.collection.get(n.id), size: e
                                            });
                ...
                var t = function (t, n) {
                    ...
                    t.on(S("\x12`qab~v~i!\x7fu\x7fqGD\x18EMICT"), function (e) {
                        ...
                        e.data.shortcuts.add({
                            label: e.finder.lang.shortcuts.general.focusFilesPane, shortcuts: S("\x1a`}qjb\vZD\x1aY")
                        })
                    }, null, null, 40)
                };
                ...
                return t.prototype.createView = function (e) {
                    ...
                    if (r === S("A6+1($)) &8")) {
                        ...
                        group: S("1TZXPE"), name: S("A6+1($\x14!3/")
                    }), n.request(S("\x13gpbcqw}h&ywlACNF"), {
                        group: S(",KGCUB"), name: S("C ,57$(3\x05- +")
                    }), t = new u(i); else {
                        if (r !== S("=]P-1# 0")) throw S("\x1fwSMMC\x05PNM^\n_U]K");
                        n.request(S("1AV@A_Y_J\0_UN_],$"), {
                            group: S("1TZXPE"), name: S("\x1ekHTOAwL\\B")
                        }), n.request(S("\v\x7fhz{y\x7fu`.q\x7fdy{v~"), {
                            group: S("&AAEOX"), name: S("C ,57$(3\x05- +")
                        }), n.request(S("=MZ45+-#6|#!:+) ("), {
                            group: S("=XV,$1"), name: S("(MCX\\AOVtPFV")
                        }), n.request(S('>L%56**"5}, 9*.!+'), {
                            group: S("\x0fvx~vg"), name: S("1VZGEZVAjSAY")
                        }), t = new d(i)
                    }
                    ...
                    return t.on(S("\x1c~vvLETJAR\x1cAAEO\x11OB@[UIF^Q[C"), function (e) {
                        e.evt.preventDefault(), n.request(S("\x18zuuhxfkmDLV"), {
                            name: S(",KGCU"), evt: e.evt, positionToEl: c(e.el), context: {file: e.model}
                        })
                    }), t.on(S('@"**(!0.->p-#!**"k1<:!3/,4?5)'), function (e) {
                        e.evt.preventDefault(), n.request(S("%EHF]OSX`KAE"), {
                            name: S("\x0fv~~wqg"), evt: e.evt, positionToEl: e.el, context: {folder: e.model}
                        })
                        ...
                        n.request(S("/VX^VG\x0fQRLj_WY^JZ$")).contains(e.model) || (n.request(S(">Y)-'0~!#4-%/(8\f\"#")), n.request(S("3R\\ZRK\x03I^PX]K"), {files: [e.model]})), function (e, t) {
                            ...
                            function u(e, t) {
                                ...
                                n.data(S("&DCO\x07O^B^")) && n.trigger(S("D&-!,;+,#;+=")), e.css({
                                    top: t.originalEvent.clientY + 10, left: t.originalEvent.clientX + 10
                                })
                            }
                        ...
                        e.model.get(S("5_DjVUO")) || n.request(S("-Z@_]PRF\x0fDRK\\N"), {
                            name: S("\x1aV}tp"), event: S("<[QS$$0"), context: {folder: e.model}
                        })
                        ...
                        page: S("C\t$/)"), region: S("\x1cp\x7fvN"), view: t
                    }), t
                    ...
                    list: function (e) {
                        e.request(S("\x0e|uefzzre-}w{ypx"), {
                            group: S("\x15p~t|i"), name: S("9NSIP\\l);'")
                        ...
                        e.request(S("C7 23!'-8v( .2=7"), {
                            group: S("%@NDLY"), name: S("5B_MTXhUG[")
                        }), e.request(S("+_HZ[Y_U@\x0ePXVZU_"), {
                            group: S("A$*( 5"), name: S("#@LUWDHSeM@K")
                        }), e.request(S("5ERLMSU[N\x04Z.  /!"), {
                            group: S("@'+/!6"), name: S("C ,57$(3\x0f-9+")
                ...
                function h(e, t) {
                    ...
                    (!n || n === r) && e.fire(S('E .$,9q?("*3%77'), {
                        files: t.getSelectedFiles(), folders: t.getSelectedFolders()
                ...
                return e.prototype.resetRangeSelection = function () {
                    ...
                    e.selectedFiles.on(S("\v~h}jd"), function () {
                        ...
                        e.request(S("\x15}ra#vroi{q"), {key: f.a}), e.on(S("\n`itj`g\x7f(") + f.a, function (e) {
                            ...
                            e.data.shortcuts.add({
                                label: e.finder.lang.shortcuts.files.selectAll, shortcuts: S("#_FRUDT\x01PMP")
                            }), e.data.shortcuts.add({
                        ...
                        e.data.shortcuts.add({
                            label: e.finder.lang.shortcuts.general.nextItem, shortcuts: S("'S[CLDYo]B^ENHNRXOW{INRIB")
                        }), e.data.shortcuts.add({
                            label: e.finder.lang.shortcuts.general.previousItem, shortcuts: S(",VBJVEsAFZAJDBOK}OLP7<")
                        }), e.data.shortcuts.add({
                            label: e.finder.lang.shortcuts.general.firstItem, shortcuts: S("\npdbcjm")
                        }), e.data.shortcuts.add({
                            label: e.finder.lang.shortcuts.general.lastItem, shortcuts: S("\x14nsy|d")
                        })
                    }, null, null, 80)
                    ...
                    e.on(S("\x16tppv\x7fjt{h\x1aGKOA\x1fEKAJA"), t), e.on(S("!AKMIBQAL]\x11JBBKUC\bPX\\U\\"), t), e.on(S("\x10rzzxq`~}n }uq{%LNLDPJSD@"), function (e) {
                        r.isInSelectionMode || (r.isInSelectionMode = !0, r.selectFiles(r.displayedFiles.indexOf(e.model), {
                            isAddToRange: !1, isToggle: !0, resetSelection: !0
                        }))
                        ...
                        if (n.keyCode !== (this.finder.lang.dir === S(">S43") ? f.left : f.right) && n.keyCode !== f.end || (t = r.displayedFiles.last()), n.keyCode !== (this.finder.lang.dir === S("\x0f|e`") ? f.right : f.left) && n.keyCode !== f.home || (t = r.displayedFiles.first()), t) {
                            ...
                            r.selectFiles(r.displayedFiles.indexOf(t), {
                                forceSelect: i, isAddToRange: !!n.shiftKey, isToggle: !!e.evt.ctrlKey || !!e.evt.metaKey
                            })
                        }
                    });
                    var r = this;
                ...
                return e.Model.extend({
                    defaults: {
                        ...
                        var r = {
                            group: S('C",*";'), label: e.settings.title, settings: [{
                                name: S("+HD]_\\PK}UXS"),
                ...
                function i(i) {
                    ...
                    r.finder = i, r.initDfd = new e.Deferred, r.config = new f, r.files = new t.Collection, r.displayedFiles = s.attachTo(r.files), r.displayedFiles.isLoading = !0, r.filesCache = new u({maxFiles: 2e3}), r.viewManager = new l(i, r.config), new a(i), i.once(S("D&)*%($/v\"%u\x19?;'"), T, r, null, 30), i.setHandlers({
                        ...
                        e.data.groups.add({
                            name: S("\x15p~t|i"), priority: 20, label: e.finder.lang.files.filesPaneTitle
                        })
                        ...
                        t.request(S("1YVM\x0fZ^KM_U"), {key: o.f5}), t.request(S(",FKV\n][@@PX"), {key: o.r}), t.on(S("1YVMQY@V\x03") + o.f5, function (e) {
                            ...
                            e.data.shortcuts.add({
                                label: e.finder.lang.shortcuts.files.refresh, shortcuts: S("\fvh:mmip`gzj3bhf")
                            })
                        }, null, null, 60)
                    }(i)
                }
                ...
                function F(e) {
                    ...
                    if (!1 !== r && (this.displayedFiles.isLoading = !1, this.files.reset(r.files)), n.fire(S(".I_]VVF\x0fQRL\x7fSWYN\x04]%'-1!"), i, n)) return n.request(S("8ZUVQ\\P[z2'- "), {
                        name: S("C\x03 2\x01!%/8"), folder: t, context: i
                    })
                }
                ...
                function _(e) {
                    ...
                    return e.size && (n.size = e.size), this.finder.request(S("\x18zuvq|p{\x1aTPO"), {
                        command: S("=jW5, -%,*"), folder: t.get(S(":]SQZZ2")), params: n
                    })
                }
                ...
                function D(e) {
                    ...
                    var n = t.request(S('B%+)"":s-.8\f-;9\'7')), i = t.request(S("4VYZUXT_\x06N[Q$"), {
                        name: S("\x14Rsc^pv~o"), folder: n, context: c.extend({folder: n}, e && e.context)
                    });
                ...
                function A() {
                    ...
                    e.doAfterInit(function () {
                        t.fire(S(".]UB]FFVSD\x02JRTK\x07\\Z&.0&"), {resources: e.resources}, t), e.files.reset(t.request(S("<O[L/40 !6| -=")).toArray()), t.config.rememberLastFolder && t.request(S(":HYIJV.&1y7 2\x11)%?."), {
                            group: S("\vjbbkuca"), name: S("\x1cq\x7flTgMO@@T"), value: "/"
                ...
                function T(e) {
                    ...
                    if (r = C(4) - C(0), C(4), C(0), r < 0 && (r = C(4) - C(0) + 33), p = r < 4, n.config.set(u), n.config.get(S(';HUKR"\x12+9!')) && n.config.get(S("\x16aq|mOem{")) === S("+XE[BR_SZXF")) {
                        ...
                        c > n.config.get(S("\fyfz}s|r}y[v`Jsay")) ? h = n.config.get(S(";HUKR\"/#*(\b'?\x1b 0.")) : c < n.config.get(S("2G\\@[UVXSWqTPl);'")) && (h = n.config.get(S(".[XD_QZT_[uPThUG["))), h && (n.config.set(S("1F[AXTdQC_"), h), n.finder.request(S(" RGWPLH@[\x13YNX{OCET"), {
                            group: S("1TZXPE"), name: S("\x11f{axtDqc\x7f"), value: h
                        }))
                    }
                    n.config.get(S("@7+&3\x11?7-")) === S("A.*71") && (i.request(S("\x1elEUVJJBU\x1dL@YJNAK"), {
                        group: S(".IY]W@"), name: S("'\\A_FN~GUU")
                    }), i.request(S('>L%56**"5}, 9*.!+'), {
                        group: S("\x1c{wsER"), name: S(">[)22/%<\b&%,")
                        ...
                        e.on(S(",]OHU\vQAQTBR\x02t[RR"), function (e) {
                            ...
                            if (!t.length) {
                                ...
                                return n ? void (!e.finder.config.displayFoldersPanel && e.data.folders.length || e.finder.request(S("\x11f|{ytvj#h~oxj"), {
                                    name: S("&jI@D"), event: S("2U[YRRJ"), context: {folder: n}
                                })) : void e.finder.request(S("%RHGEHJ^\x17\\JCTF"), {
                                    name: S("$hGNF"), event: S("\x0e}ub}ffvsd")
                                })
                            }
                            1 < t.length ? e.finder.request(S("-Z@_]PRF\x0fDRK\\N"), {
                                name: S("\x1fm@KM"), event: S(";ZTRZ3"), context: {files: t}
                            }) : e.finder.request(S("'\\FEGNL\\\x15BTAV@"), {
                                name: S("\x18T{rr"), event: S("(OCGI"), context: {file: t.at(0)}
                            })
                        }, this)
                    ...
                    if (function (t) {
                        function e() {
                            return t.request(S("D5' -s+/(\x1f+(9><"), {
                                page: S("5{VQW"), name: n, id: t._.uniqueId(S("\x1b\x7fvx2")), priority: 10
                            })
                        }
                        ...
                        function i() {
                            ...
                            e[S("&JMZYJKH")] = [S("1b^[A"), S(" LT"), "e", S("\x16wxrr"), S("0CRG@TPS"), S("\x0eds"), S('?\x07\x0f\x02-"()>'), "7"][S("6ZYI")](function (e) {
                                ...
                                view: new (t.Backbone.Marionette.ItemView.extend({
                                    attributes: {
                                        "data-role": S("?($#'!7"), "data-theme": "a" === t.config.swatch ? "b" : "a"
                                    },
                ...
                function B(e) {
                    ...
                    e.finder.request(S("\x1fFNNGAW\x1cUMOXN_EhF\\TA")), e.finder.request(S("\x1b\x7frsrAOF\x19W@HC"), {
                        name: S('"dAQ`HDMOY_'), folder: t, context: {parent: t}
                    })
                }
                ...
                var g = null, r = n.debounce(h.redraw, 30), p = {
                    oninit: function (e) {
                        ...
                        var d = [h("a", {
                            ...
                            class: u.join(" "), onclick: this.expanderOnClick.bind(this)
                        })];
                        if (s || a) {
                ...
                return e.Model.extend({
                    defaults: {done: 0, lastCommandResponse: !1}, initialize: function () {
                        ...
                        this.set(S("\x0ecqbfAqffxvj\x7f"), {
                            done: this.get(S(".[IAW")) === S("\x17[vjb") ? e.copied : e.moved, response: e
                        });
                ...
                "use strict";
                return e.extend({
                    name: S("\x18Tumy^qoYdPQKWUqAL]"), template: t, ui: {
                    ...
                    switch (e.data.response.error.number) {
                        ...
                        case 116:
                            ...
                            n.get(S("\x19ysuqzmEO")).remove(t), e.finder.request(S('C"**#-;p,)9\x0f,$8$6')) === t && e.finder.request(S("+JBBKUC\b\\DPXgYMR"), {
                                path: n.getPath({full: !0}), expand: !0
                            });
                            break;
                        case 103:
                        ...
                        action: function () {
                            ...
                            t.on(S("=]W)-&5- 1}.&&/)?t*(!3=0"), function (e, t) {
                                ...
                                o.finder.request(S("E .$,9q") + r.toLowerCase(), {
                                    files: o.finder.request(S("+JDBJC\vUV@fS[]ZN^X")), toFolder: t.view.model
                                })
                                ...
                                t.evt.keyCode !== l.enter && t.evt.keyCode !== l.space || (t.evt.preventDefault(), t.evt.stopPropagation(), o.finder.request(S("-HF\\TA\t") + r.toLowerCase(), {
                                    files: o.finder.request(S("\x1c{wsER\x18DAQuBDLI_II")), toFolder: t.view.model
                                }))
                    ...
                    e.data.items.add({
                        ...
                        action: function () {
                            e.finder.request(S("\x1c{wsER\x18NKSC"), {
                                files: e.finder.request(S("\x1a}uq{l\x1aFGWw@JBK]OO")), toFolder: t
                            })
                        }
                    }), e.data.items.add({
                        name: S(",nA_Iw[_QF"),
                        ...
                        action: function () {
                            e.finder.request(S("\x19|rpxm%CNRZ"), {
                                files: e.finder.request(S("D#/+-:p,)9\x1d*<41'11")), toFolder: t
                            })
                        }
                    })
                }
                                ...
                                if (!r.error || !f.includes([103, 116], r.error.number)) {
                                    ...
                                    if (l.set(S("\x15{d\x7f"), u.replace(S("\x19axshpk]"), l.get(S("\x1dzpND")))), l.set(S('<XLM/31\x17-1*"'), s.lang[l.get(S("3@LFR")).toLowerCase()].errorDialogTitle), l.set(S("@2*,3\x06')+,&"), E(s)), !l.hasFileExistErrors()) {
                                        ...
                                        return l.hasOtherErrors() && (l.set(S("\x14xep"), s.lang.errors.operationCompleted + " " + l.get(S("'EZM"))), o = new m({
                                            ...
                                            view: o, title: c, name: w, uiOptions: {
                                            ...
                                            title: c, msg: l.get(S("\x0ebcv")), name: S("-c@FTq\\DLeBUT[IEtPY/")
                                    ...
                                    l.nextError(), l.addErrorMessages(s.lang.errors.codes), function (e, t, n) {
                                        ...
                                        if (!i) {
                                            ...
                                            E(t) ? (t.request(S("*[MJK\x15SCWR@P"), {
                                                view: i, title: r, name: y, uiOptions: {
                                                ...
                                                name: y, title: r, buttons: [S(".LQ_QVX")], view: i
                                            })
                                        }
                                        return i
                    ...
                    events: {
                        touchstart: function (e) {
                            ...
                            this.finder.request(this.finder.util.isShortcut(e, "") ? S("\x13rzubk#t~di") : S("8_UXIN\x04O2$4"), {
                                node: this.ui.container, event: e
                            })
                        ...
                        this.breadcrumbs = new t.Collection, this.breadcrumbsView = function (e, t) {
                            ...
                            return e.on(S("\x1fP@EF\x1eVNH_\x13gJEC"), function () {
                                e.request(S("2CURS\rY]^iYZWP."), {
                                    ...
                                    view: n, page: S("\rCny\x7f"), region: S("\x17zk\x7fzx~ljMCQ")
                                })
                            }), n
                    ...
                    if ("/" !== e.path) {
                        ...
                        o || (o = this.resources.first()), n && function (n, e, t, i) {
                            ...
                            d.defer(function () {
                                ...
                                name: S("A\x05&0\x03)+,,88"), folder: l, context: {silentConnectorErrors: !0, parent: l}
                            }).done(function (e) {
                                if (e.error) {
                                ...
                                l.set(S("\x15wtt"), g(e.currentFolder.acl)), l === r.request(S(".I_]VVF\x0fQRLxYOUK[")) && u && r.request(S("5BXWUXZN\x07LZ3$6"), {
                                    name: S("4xW^V"), event: S("7^VV_YO"), context: {folder: l}
                                })
                            ...
                            r.get(S('D,5\x17-\'.""*')) || r.get(S('"KEVeOAENYIC')) && e && !t ? l.request(S("<^QR- ,'~6#),"), {
                                name: S("\x1fgDVeKIBBZZ"), folder: r, context: {parent: r}
                ...
                function u(e) {
                    ...
                    !(i && i.cid === n.cid) && i && i.trigger(S("\x13ppert|yoyy"), i), this.currentFolder = n, t.request(S("1Q\\YXWY\\\x03I^RY"), {
                        name: S("B\x04!1\0($-/9?"), folder: n, context: {parent: n}
                    }), n.trigger(S(">L%-' 0 \""), n), t.fire(S("1T\\XQSE\x02J_WY^JZ$"), {
                        folder: n, previousFolder: i
                    }, t)
                }
                ...
                function c(e) {
                    ...
                    if (n && !n.error) {
                        ...
                        d.isArray(i) && d.forOwn(i, function (e, t) {
                            r.push(function (e) {
                                return d.extend(e, {
                                    path: "/", isRoot: !0, resourceType: e.name, acl: g(e.acl)
                                }), new o(e)
                            }(i[t]))
                ...
                function p(e) {
                    e.data.folder.get(S("\x1cu\x7flcIKO@WCI")) && e.data.folder.get(S("%EOAENYIC")).size() <= 0 && e.finder.request(S("\x11q|yxwy|#i~ry"), {
                        name: S('"dAQ`HDMOY_'), folder: e.data.folder, context: {parent: e.data.folder}
                    })
                }
                ...
                function v() {
                    ...
                    if (n = this.finder, M = M || (o = I(n.config.initConfigInfo.c), function (e) {
                        ...
                        var a = n.request(S("6D]MNRRZM\x05'$6\x15%)3\""), {
                            group: S("7^VV_YOM"), name: S("\x1bp|mkfNNGAW")
                        });
                    ...
                    m.length && m.forEach(function (e) {
                        ...
                        e.set(S("+DL]lXX^WFPX"), !0), e.set(S("\nb\x7f]katx|t"), !0), t !== v && n.request(S('"@KHKFFM\x10XICJ'), {
                            name: S(":|YIxP,%'17"), folder: e, context: {parent: e}
                        })
                ...
                return function (t) {
                    ...
                    n.finder = t, n.resources = new h, t.config.displayFoldersPanel ? (function (o) {
                        ...
                        (o.view = e).on(S("\x14v~~t}lryj$yOMFFV\x1fC_XHDO"), function (e, t) {
                            ...
                            s.fire(S("4SY[\\\\H\x01WXG[/6,"), {
                                evt: t.evt, view: t.view, folder: t.model, source: S("A$,(!#5;=8.)")
                            }, s)
                            ...
                            function r() {
                                a(S("\x12Hptbv5zq}1m\x7fxE\x1c\0nELH\x05u\t\x04^E\0^N^T^\x1eCGWGH\\H")).css(s.lang.dir === S("\x11~gf") ? {
                                    "margin-right": s.config.primaryPanelWidth, left: s.config.primaryPanelWidth
                        ...
                        116 !== e.data.response.error.number || e.data.context.silentConnectorErrors || (e.cancel(), e.finder.request(S("5R^YUU\\\x06TPY/"), {msg: e.finder.lang.errors.missingFolder}), e.finder.request(S("-H@\\UWA\x0eZFRVi[OT"), {
                            path: e.data.context.parent.get(S("%VFZLD_")).getPath({full: !0}), expand: !0
                        }))
                        ...
                        t.request(S("\x0fd~}\x7fvtd-j|i~h"), {
                            name: S("9wZUS"), event: S('B%+)"":'), context: {folder: e.data.folder}
                        })
                    });
                    ...
                    t.on(e, function () {
                        ...
                        e.data.shortcuts.add({
                            label: e.finder.lang.shortcuts.general.focusFoldersPane, shortcuts: S("\run|eo8os.j")
                        })
                    }, null, null, 30), t.on(S("$VNHZ]I^X^\x14CYBF"), function (e) {
                        e.data.groups.add({
                            name: S("?&..'!75"), priority: 30, label: e.finder.lang.shortcuts.folders.title
                        })
                    })
                }
                    ...
                    templateHelpers: function () {
                        ...
                        return {
                            ...
                            url: this.finder.request(S("\fnab}p|w.`d{"), {
                                command: S("B\x05-)#\x128%%*("), folder: e, params: {asPlainText: !0}
                            }),
                ...
                return function (r) {
                    ...
                    r.hasHandler(S("2FDYYV\\")) || (r.on(S("E6&/,p(>(/;5k\x1f2=;"), function () {
                        r.request(S("@1#$!\x7f'#,\x1b/,%\" "), {
                            page: S("?\r +-"), name: S("*^\\AANT"), id: e.uniqueId(S("\x1fCJD\x0e")), priority: 20
                        })
                ...
                return e.prototype.getState = function () {
                    ...
                    if (t) t.abort(); else {
                        ...
                        var n = this.state, i = e.get(S("\x11tzxp")).size, r = n.get(S("+XBZN\\w[_QF")),
                            o = n.get(S(")^DXLBmIEW@"));
                        n.set({
                            totalFiles: r ? r - 1 : 0, totalBytes: o ? o - i : 0
                ...
                return i.extend({
                    name: S("C\x115*()-\f$> "), template: o, ui: {
                    ...
                    }, regions: {progress: S("0\x12QXR\x18CGTV[_\x11MLP'3'07")}, events: {
                        ...
                        this.isDetailsEnabled = !1, this.$el.enhanceWithin(), l.call(this, this.finder.request(S("\x1fUH\x18DAQkHLL"))), this.disableDetailsButton(), this.progress.show(new s({
                            finder: this.finder, model: this.progressModel
                        }))
                    }, updateView: function () {
                ...
                return function (u) {
                    ...
                    (function () {
                        ...
                        u.request(S("1BRSP\fV\\]h^[TQQ"), {
                            page: S("\x16Zypt"), name: S("\x1anlqq~DgKOAV"), id: E.uniqueId(S("0RYU\x19")), priority: 20
                        })
                        ...
                        if (n) if (D = function (e, t) {
                            ...
                            i.on(S("D7#4-="), function () {
                                ...
                                finder: u, model: l, events: E.extend({}, _.prototype.events, {
                                ...
                                view: h, page: S("*fMD@"), region: S("%SWDFKOjDBJC")
                    ...
                    (this.finder = n).setHandlers({
                        "loader:show": function (e) {
                            i(), o.mobile.loading(S("E5/'>"), {
                                text: e.text, textVisible: !!e.text, theme: n.config.swatch
                            });
                    ...
                    if (n.util.isPopup() || n.util.isModal() || n.util.isWidget()) {
                        ...
                        var i = !1, e = function (e) {
                            ...
                            return t = e.util.isPopup() ? (n = function () {
                                ...
                                s(r.document).css({
                                    overflow: S("\x14}\x7fs||t"), width: 0, height: 0
                ...
                return e.extend({
                    createRegion: function (r) {
                        ...
                        this.ui.regions.find(S("9a_]I_\x12#*$n47/(: >2\x11")).each(function (e, t) {
                            ...
                            selector: "#" + r.id, priority: r.priority
                        })
                ...
                return e.prototype = {
                    getHandlers: function () {
                        ...
                        return !!t && (t.createRegion({
                            name: e.name, id: e.id, priority: e.priority ? e.priority : 50, className: e.className
                        }), !0)
                        ...
                        function t() {
                            ...
                            if (e.length) {
                                ...
                                this.contents.$el.css({
                                    height: this.$el.height() - parseInt(t) - n + S("9JC"), overflow: S("\x12raay")
                                })
                            }
                        }
                ...
                function l(e, i) {
                    ...
                    i.request(S("\x18uuzxxl%SIMT"), {text: i.lang.common.pleaseWait}), i.once(S("\x1e|OLOBJA\x1cFN]OY\x16\x7fKAQ\\Wu]YS"), function (e) {
                        ...
                        name: S("+~H@N]TtZXP"), folder: t, params: n, type: S("\v|b}{")
                    })
                }
                ...
                return e.prototype.getId = function () {
                    ...
                    this.probingInterval = setInterval(function () {
                        n && (n = !1, e.finder.request(S("A!,)('),s9.\")"), {
                            name: S("A\r3!7'3!&$"), params: {operationId: e.id}
                        }).done(function (e) {
                            n = !0, t && t(e)
                        }))
                    }, 3e3)
                    ...
                    this.finish(), this.finder.request(S("\x16twtwzry$lEOF"), {
                        name: S(")e[I_O[Y^\\"), params: {operationId: this.id, abort: !0}
                    })
                ...
                return function (d) {
                    d.setHandler(S("?&..'!7|5-'+&)"), function (e) {
                        ...
                        if (n) {
                            ...
                            var u = new f.Model({
                                dialogMessage: d.lang.folderRename, folderName: t.get(S("\x13zt{r")).trim(), error: !1
                        ...
                        if (!t.get(S("4PDEWK"))) {
                            ...
                            e.finder.request(S("\x17|p{wsz${ERVQK\\")), d.request(S("\x0ei\x7f}vvf/drvxw~"), {
                                folder: e.data.context.folder, newFolderName: n
                            })
                        }
                    ...
                    var n = "", i = {
                        "input input": function () {
                            ...
                            e.keyCode === s.tab && (t.util.isShortcut(e, "") || t.util.isShortcut(e, S(":HTTXK"))) && t.request(t.util.isShortcut(e, "") ? S("\rh`sda)zpnc") : S("/V^QFG\x0fFE]O"), {
                                node: this.$el.find(S("<TPO55")), event: e
                            }), e.stopPropagation()
                        }
                    };
                    (function () {
                ...
                "use strict";
                return i.extend({
                    name: S("=l^$(-\x10!12.&."), template: r, templateHelpers: {_: e}, events: {
                ...
                "use strict";
                return n.extend({
                    tagName: S("&CA_"), name: S("+~L@HUbWG@\\XP"), template: i, events: {
                        "change input": function (e) {
                        ...
                        "settings:define": function (n) {
                            ...
                            function u(e, t) {
                                ...
                                c.fire(S("B0!12.&.9q/%/!74h") + n, {
                                    settings: o.getSettings(), changed: i
                ...
                "use strict";
                var o = e.extend({
                    name: S("@\x12*,61%2<\x1f#.;"), tagName: S("\x14ad"), template: r, templateHelpers: function () {
                    ...
                    name: S("\nXdb|{sdf`WzzbuwLryj"), template: "", childView: s, initialize: function (e) {
                ...
                return function (t) {
                    t.request(S(",FKV\n][@@PX"), {key: e.slash}), t.on(S("0ZWJPZAY\x02") + e.slash, function (n) {
                        ...
                        e.data.shortcuts.add({
                            label: e.finder.lang.shortcuts.general.listShortcuts, shortcuts: S(" ZSVAVRNGGW")
                        })
                    }, null, null, 70)
                }
                    ...
                    (i.finder = n).setHandlers({
                        "statusBar:create": function (e) {
                            ...
                            t && t.get(S("\x11prf")).createRegion({
                                id: e.id, name: e.id, priority: e.priority ? e.priority : 50
                            })
                ...
                return e.extend({
                    ...
                    initialize: function (e) {
                        ...
                        s.name = e.name, s.page = e.page, s.toolbarOptions = {
                            position: S(".IYIWW"), tapToggle: !1, updatePagePadding: !0
                                ...
                                events: {
                                    keyup: function (e) {
                                        e.keyCode !== a.enter && e.keyCode !== a.space && this.trigger(S("\x1evTDOHA\\BH_G"), {
                                            evt: e, view: this, model: this.model
                                        })
                                    }, keydown: function (e) {
                ...
                var t = o.Model.extend({
                    defaults: {
                        type: S("\x1e}UUVLJ"), alignment: S(";LOWR!3;"), priority: 30, alwaysVisible: !1
                    }
                ...
                return i.prototype.reset = function (e, t) {
                    ...
                    n.finder.fire(S('\n\x7fcbbmqc(aqfsc"') + n.name, i, n.finder), e && n.finder.fire(S("\x19ntsq|~R\x1bPFW@R\x1d") + n.name + ":" + e, i, n.finder), i.toolbar.push({
                        ...
                        action: function () {
                            ...
                            n.currentToolbar.showMore = new s({
                                finder: n.finder, collection: t, positionToEl: e.$el
                    ...
                    this.toolbarView = new n({
                        finder: e, collection: this.currentToolbar, name: this.name, page: t
                ...
                return function (e) {
                    e.on(S("\x17lvuw~|l%RDQFP\x1fkFAG\x10MCAJJB"), t), e.on(S("<IQP,##1~7#4-=p\x06-$ u68>6"), t), e.on(S("A6,+)$&:s8.?(:u\x1d0;=n3?;=*"), t), function (t) {
                        t.request(S('"HA\\\x1cKAZ^NB'), {key: n.u}), t.on(S("\x11yvmqy`v#") + n.u, function (e) {
                            ...
                            e.data.shortcuts.add({
                                label: e.finder.lang.shortcuts.files.upload, shortcuts: S(" ZCOPX\r\\]T")
                            })
                        }, null, null, 40)
                    }(e)
                }
                ...
                return t.templateSettings.doNotSkipEncoded = !0, {
                    start: function (n) {
                        ...
                        return i.templateCache = new f(i), i.renderer = new h(i), i.hasHandler = function () {
                            ...
                            e.data.groups.add({
                                name: S("\x14rsy}k{w"), priority: 10, label: e.finder.lang.shortcuts.general.title
                            })
                        }), i.on(S("-]G_CFPAAE\rTPIO\x06Z[Q%3#/"), function (e) {
                            e.data.shortcuts.add({
                                label: e.finder.lang.shortcuts.general.action, shortcuts: S("8B_UHXLB")
                            }), e.data.shortcuts.add({
                                label: e.finder.lang.shortcuts.general.focusNext, shortcuts: S("\x17cm{ya")
